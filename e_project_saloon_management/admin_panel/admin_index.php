        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
// Fetch total earnings from the database or calculate it
...
$sql = "SELECT COUNT(*) AS pending_requests FROM appointments WHERE status = 'pending'";
$result = $conn->query($sql);
...
<?php
// Fetch count of total registered users
...
<!-- Total Registered Users Card Example -->
<div class="col-xl-4 col-md-6 mb-4">
