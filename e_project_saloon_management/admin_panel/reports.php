    ...
    <div class="container">
        ...
        <div class="report-section">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT a.appointment_date, s.service_name, u.user_name, a.status 
                            FROM appointments a
        ...
        <div class="report-section">
            ...
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc()) {
                echo "<p>{$row['service_name']} - {$row['count']}</p>";
            }
            ?>
        </div>
        ...
        <div class="report-section">
            ...
            <?php
            $sql = "SELECT HOUR(a.appointment_date) as hour, COUNT(*) as count 
                    FROM appointments a
                    GROUP BY hour 
                    ORDER BY count DESC 
                    LIMIT 5";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc()) {
                echo "<p>{$row['hour']}:00 - {$row['count']}</p>";
            }
            ?>
        </div>
    </div>
