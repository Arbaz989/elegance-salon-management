<?php
session_start();
include $_SERVER['DOCUMENT_ROOT'] . '/e_project_saloon_management/admin_panel/db_connection.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO payments (appointment_id, amount) VALUES ('$appointment_id', '$amount')";
...
$sql = "
    SELECT p.id, p.appointment_id, p.amount, p.payment_date, a.user_name, s.service_name 
    FROM payments p
...
<head>
    ...
    <title>Payment Managemetn</title>
    <style>
        body { font-family: 'Arial', sans-serif; background-color: #f8f9fa; margin: 0; padding: 0; }
        .container { max-width: 900px; margin: 30px auto; padding: 20px; background-color: #fff; box-shadow: 0 0 10px rgba(0,0,0,0.1); border-radius: 8px; }
        h1, h2 { text-align: center; color: #343a40; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        table th, table td { padding: 12px 15px; border: 1px solid #dee2e6; }
        ...
        form input[type="number"] { width: 100%; padding: 10px; margin-bottom: 20px; border: 1px solid #ced4da; border-radius: 4px; }
        form input[type="submit"] { width: 100%; padding: 10px; background-color: #007bff; border: none; border-radius: 4px; color: #fff; font-weight: bold; cursor: pointer; }
...
<body id="page-top">
 ...
 -->
    ...
    <div class="container">
        <h1>Record and Display Payments</h1>
        ...
        <?php else: ?>
            <p>No recorded payments found.</p>
        <?php endif; ?>
    </div>
