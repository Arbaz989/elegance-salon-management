            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-text">
                            <h1>BARBER X SALON</h1>
                            <p>
                            The Best Barber Shop in Town

Offering top-notch facilities and skilled barbers. Book now for great deals. 
                            </p>
                            <a class="btn" href="book_appointment.php">Make an appointment</a>
                        </div>
                    </div>
